...
{/* directionalLight positioned below will shine upward toward the scene center */}
<directionalLight
  position={[0, -6, 0]}
  intensity={0.9}
  color="#fff9f0"
...
/* Directional light from above to illuminate cones */
<directionalLight
  position={[0, 12, 0]}
  intensity={1.6}
  color="#fff7ea"
...
{/* subtle fill to soften shadows */}
<hemisphereLight skyColor="#ffffff" groundColor="#222222" intensity={0.25} />
 
{/* --- NEW: warm bottom lights aiming at center --- */}
{/* focused warm spotlight from below to highlight cone undersides */}
<spotLight
  position={[0, -6, 0]}
  intensity={1.0}
  color="#ffdfc2"
...
{/* subtle warm point fill from below for soft wrap lighting */}
<pointLight
  position={[0, -3, 0]}
  intensity={0.35}
  color="#ffd9a0"
